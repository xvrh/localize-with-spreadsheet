...
transformer.save("samples/values/nl.dart", { valueCol: "NL", format: "dart", header: 'library pdwg.translations.nl;' });
transformer.save("samples/values/fr.dart", { valueCol: "FR", format: "dart" });
