...
var dartTemplateTransformer = {
    ...
    insert: function (input, newValues, options) {
        ...
        var output = input + dartTransformer.AUTOGENERATED_TAG + EOL +
            'class ' + className + ' extends Translations { ' + EOL + EOL +
            '  T(values): super(values);' + EOL + EOL +
            newValues + EOL +
            '}';
...
module.exports = {'ios': iOSTransformer, 'android': androidTransformer, 'dart': dartTransformer, 'dartTemplate': dartTemplateTransformer, '.net': dotNetTransformer };
