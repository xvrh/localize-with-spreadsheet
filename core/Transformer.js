...
var jsonTransformer = {
    ...
    insert: function (input, newValues, options) {
        ...
        var generatedIndex = input.indexOf(jsonTransformer.AUTOGENERATED_TAG);
        if (generatedIndex >= 0) {
            input = input.substr(0, generatedIndex);
        }
        ...
        var output = input + jsonTransformer.AUTOGENERATED_TAG + EOL +
                     header +
                     '{' + EOL +
                     newValues + EOL
                     + '};';
...
module.exports = {'ios': iOSTransformer, 'android': androidTransformer, 'json': jsonTransformer, 'dartTemplate': dartTemplateTransformer, '.net': dotNetTransformer };
